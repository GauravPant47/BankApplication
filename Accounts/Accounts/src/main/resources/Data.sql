...
INSERT INTO `accounts` (`customer_id`,`account_type`, `branch`, `created_date`)
VALUES (1, 'Savings', 'Chennai', CURDATE());

INSERT INTO `accounts` (`customer_id`,`account_type`, `branch`, `created_date`)
VALUES (2, 'Savings', 'New Delhi', CURDATE());

INSERT INTO `accounts` (`customer_id`,`account_type`, `branch`, `created_date`)
VALUES (3,'Savings', 'Bangalore', CURDATE());